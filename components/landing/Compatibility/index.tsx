...
function Compatibility() {
    ...
    return (
        <section
            className="w-full min-h-screen mt-10 flex flex-col overflow-hidden items-center"
        >
            <h1 className="font-bold mb-14 "> Compatible With </h1>
            <Text size="xl" mb={20} color={'dimmed'} className="font-semibold " mt={10}>
            ...
            <Text size="xl" mb={20} color={'dimmed'} className="font-semibold " mt={30}>
