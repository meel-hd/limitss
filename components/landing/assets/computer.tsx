const SvgComponent = (props) => (
  ...
  >
    <path
      ...
      className="st322"
    />
    <path d="M686 9H27.6c-8.4 0-15.1 6.8-15.1 15.1v431.7c0 8.4 6.8 15.1 15.1 15.1H686c8.4 0 15.1-6.8 15.1-15.1V24.1c0-8.3-6.8-15.1-15.1-15.1zm5 14.3v433.5c0 2.3-1.9 4.2-4.2 4.2h-660c-2.3 0-4.2-1.9-4.2-4.2V23.3c0-2.3 1.9-4.2 4.2-4.2h660.1c2.2 0 4.1 1.9 4.1 4.2z" />
    <path
      fill="#c9c8cc"
