    ...
    <>
      <Tooltip radius={999} label="Publish">
        <ActionIcon onClick={() => setOpened(true)}>
          <CloudUpload color="rgb(96 165 250)" />
        </ActionIcon>
      </Tooltip>
      <Drawer
        title={
      ...
      >
        {isPublished ? (
          <Text size="lg" weight={500} m={10}>
            This app is already published as a game!
          </Text>
        ) : (
          <>
            <div className="px-10 py-4">
              <h2 className="font-semibold text-lg">Select Installers</h2>
              <h4 className="text-gray-400 text-xs ml-4">
                Make sure to choose the right installers, you can not change
                them after uplaod
              </h4>
              <>
                <FileInput
                ...
                macUploadStatus === "Uploaded!" &&
                  ...
                  linuxUploadStatus === "Uploaded!" && (
                    <div className="shadow-lg rounded-3xl overflow-x-hidden flex flex-col gap-2 mt-5 px-5 py-3">
                      ...
                      <h4 className="text-gray-400 text-xs ml-4">
                        Make sure to choose the right installers, you can not
                        change them after uplaod
                      </h4>
                      <p>mac:</p>
                      <a
