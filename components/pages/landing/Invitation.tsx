...
function JoinInvitation() {
  return (
    <section className="w-full relative min-h-screen mt-20 flex flex-col sm:flex-row overflow-hidden items-center">
      <div className="w-full lg:w-1/2 h-1/2 p-2 sm:p-10 flex flex-col items-center justify-center">
        <h1 className="font-semibold text-center sm:text-start text-4xl mb-14 ">
