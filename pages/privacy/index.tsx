...
function Privacy() {
  ...
  return (
    <>
      <Head>
        <title>Privact Policy</title>
        <meta name="description" content="Limitss privacy policy." />
      </Head>
      <Header />
        ...
        >
          <div className="px-6 py-8  rounded-lg shadow-md  bg-white/10 backdrop-blur-xl">
            ...
            <p className="text-base opacity-95 mb-6">
              At Limitss, we are committed to protecting the privacy of our
              customers and users of our website www.limitss.com . This Privacy
              Policy outlines the information we collect, how it is used, and
              the steps we take to ensure it is protected.
            </p>
            <h3 className="text-lg font-medium mb-4">Information We Collect</h3>
            <ul className="list-disc list-inside text-base opacity-95 mb-6">
              ...
              <li>
                {
                  " Parts of the site may utilize cookies just for security and authentication purposes. This data isn't shared or sold to outsider associations for any reason."
                }
              </li>
            </ul>
            ...
            <p className="text-base opacity-95 mb-6">
              ...
              communicate with you, and personalize your experience on our
              website. We may also use your information to send you promotional
              materials or advertising, you have the ability to unsubscribe at
              any moment.
            </p>
            <h3 className="text-lg font-medium mb-4">
            ...
            <p className="text-base opacity-95 mb-6">
              ...
              our data collection, storage, and processing practices and
            ...
            <h3 className="text-lg font-medium mb-4">Third-Party Websites</h3>
            <p className="text-base opacity-95 mb-6">
